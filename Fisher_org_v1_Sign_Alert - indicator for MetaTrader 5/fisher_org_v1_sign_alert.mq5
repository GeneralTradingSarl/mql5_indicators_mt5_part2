...
//---     
   BuySignal("Fisher_org_v1_Sign",BuyBuffer,rates_total,prev_calculated,close,spread);
   SellSignal("Fisher_org_v1_Sign",SellBuffer,rates_total,prev_calculated,close,spread);
//---         
   return(rates_total);
  }
//+------------------------------------------------------------------+
//| Buy signal function                                              |
//+------------------------------------------------------------------+
void BuySignal(string SignalSirname,      // текст имени индекатора для почтовых и пуш-сигналов
...
//+------------------------------------------------------------------+
void SellSignal(string SignalSirname,      // текст имени индекатора для почтовых и пуш-сигналов
